		...
		void OnGUI(){
			...
			if(GI_PROXY_script!=null){
				...
				///// Rotate sun
					...
					Bloomer.bloomIntensity = GUI.HorizontalSlider(new Rect(0,460,200,30),Bloomer.bloomIntensity ,0.1f,0.65f);

					//v3.4
					GUI.TextArea(new Rect(0,490-28+25,200,25),"Sun ray Intensity");
					//Debug.Log (RenderSettings.ambientLight.r);
					VolumeLight.heightRayleighIntensity = GUI.HorizontalSlider(new Rect(0,490+25,200,30),VolumeLight.heightRayleighIntensity ,0.03f,0.8f);
