...
//								Keys [7] = new GradientColorKey (new Color (1, 1, 1) / 255f, 1.000f);
						...
						if(script.SkyManager.VolShaderCloudsH != null){
							...
							EditorGUILayout.BeginHorizontal ();
							script.SkyManager.VolShaderCloudsH.CloudDensity = EditorGUILayout.Slider (script.SkyManager.VolShaderCloudsH.CloudDensity, 0.00004f, 0.0002f, GUILayout.MaxWidth (sliderWidth));
							EditorGUILayout.EndHorizontal ();
