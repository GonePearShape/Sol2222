...
namespace Artngame.SKYMASTER {
	...
	public class WaterHandlerSM : MonoBehaviour {
		...
		public float fogDensity = 0.8f;//fogDepth use 1 with 2 bias to 0.5 with 50 bias, 1.5 - 1 and 20 for underwater
		public float fogBias  = 2.0f;
		public float fogStartDistance = 100;//start distance
