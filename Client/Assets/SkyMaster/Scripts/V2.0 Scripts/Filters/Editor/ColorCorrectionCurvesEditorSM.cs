...
{
    [CustomEditor (typeof(ColorCorrectionCurvesSkyMaster))]
    class ColorCorrectionCurvesEditorSM : Editor {
        ...
        void ApplyCurves () {
            if (applyCurveChanges) {
                serObj.ApplyModifiedProperties ();
                (serObj.targetObject as ColorCorrectionCurvesSkyMaster).gameObject.SendMessage ("UpdateTextures");
            }
        }
