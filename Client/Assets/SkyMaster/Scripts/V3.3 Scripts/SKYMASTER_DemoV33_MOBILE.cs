...
public class SKYMASTER_DemoV33_MOBILE : MonoBehaviour {
	...
	void Start () {
		...
		void Update(){
			...
			if (SUNMASTER.Rot_Sun_X > 0) {
				SUNMASTER.Mesh_Terrain_controller.fog_depth = Mathf.Lerp(SUNMASTER.Mesh_Terrain_controller.fog_depth,7,Time.deltaTime);
				...
				SUNMASTER.Mesh_Terrain_controller.fog_depth = Mathf.Lerp(SUNMASTER.Mesh_Terrain_controller.fog_depth,0,Time.deltaTime);
...
//		public GameObject farOceanplane;
	...
	void OnGUI() {
			...
			if (GUI.Button (new Rect (1*BOX_WIDTH+5, 0 * BOX_HEIGHT, BOX_WIDTH - 2, 22), "Eclipse")) {	
				SUNMASTER.Latitude = -15;
				SUNMASTER.Longitude = 0;
...
//			}
			...
			SPEED = GUI.HorizontalSlider(new Rect(2, 1*BOX_HEIGHT+25, 100-2, 30),SPEED,0.2f,70f);
			SUNMASTER.SPEED = SPEED;
				...
				if (GUI.Button(new Rect(5*(BOX_WIDTH+XOffset)+0, 0, BOX_WIDTH+50, 22), "Cycle sky presets:"+SUNMASTER.Preset)){
				...
				//SNOW
				if(SnowMat!=null){
					GUI.TextArea( new Rect(2, 4*BOX_HEIGHT+0, 100-2, 20),"Terrain cover");
					SUNMASTER.SnowCoverage = GUI.HorizontalSlider(new Rect(2, 4*BOX_HEIGHT+25, 100-2, 15),SUNMASTER.SnowCoverage,0.0f,3.50f);
				}

				GUI.TextArea( new Rect(1*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50, 100-2, 20),"Sky ambience");
				SUNMASTER.SkyColorationOffset = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50, 100-2, 15),SUNMASTER.SkyColorationOffset,-0.4f,0.4f);

				GUI.TextArea( new Rect(1*(BOX_WIDTH+XOffset), 4*BOX_HEIGHT+0, 100-2, 20),"Cloud glow");
				SUNMASTER.L1Ambience = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 4*BOX_HEIGHT+25, 100-2, 15),SUNMASTER.L1Ambience,0f,1.20f);

				GUI.TextArea( new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+10, 100-2, 20),"Cloud size");
				SUNMASTER.L1CloudSize = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+25+10, 100-2, 15),SUNMASTER.L1CloudSize,0f,2f);

				GUI.TextArea( new Rect(2*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+10, 100-2, 20),"Cloud cover");
				SUNMASTER.L1CloudCoverOffset = GUI.HorizontalSlider(new Rect(2*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+25+10, 100-2, 15),SUNMASTER.L1CloudCoverOffset,0f,0.2f);
...
//			}
			...
			//DOME CONTROL		
				GUI.TextArea( new Rect(2*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT, BOX_WIDTH+0, 20),"Latitude="+SUNMASTER.Latitude);			
			...
			//SUNMASTER.Rot_Sun_Y = Dome_rot;
				SUNMASTER.Latitude = GUI.HorizontalSlider(new Rect(2*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25, BOX_WIDTH+0, 30),SUNMASTER.Latitude,-89.99f,89.99f);

				GUI.TextArea( new Rect(2*(BOX_WIDTH+XOffset),1*BOX_HEIGHT+50, BOX_WIDTH+0, 20),"Longitude="+SUNMASTER.Longitude);
				SUNMASTER.Longitude = GUI.HorizontalSlider(new Rect(2*(BOX_WIDTH+XOffset),1*BOX_HEIGHT+50+25, BOX_WIDTH+0, 30),SUNMASTER.Longitude,-180,180);

				GUI.TextArea( new Rect(2*(BOX_WIDTH+XOffset), 4*BOX_HEIGHT, BOX_WIDTH+0, 20),"Moon size");
				SUNMASTER.MoonSize = GUI.HorizontalSlider(new Rect(2*(BOX_WIDTH+XOffset), 4*BOX_HEIGHT+25, BOX_WIDTH+0, 30),SUNMASTER.MoonSize,0.035f,5);

				GUI.TextArea( new Rect(3*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+0, 365, 20),"Day="+SUNMASTER.Current_Day);
				SUNMASTER.Current_Day = GUI.HorizontalSlider(new Rect(3*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25, 365, 30),SUNMASTER.Current_Day,0,365);
...
//				SUNMASTER.windZone.windMain  = GUI.HorizontalSlider(new Rect(4*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25, BOX_WIDTH+0, 30),SUNMASTER.windZone.windMain ,0,24);		
			...
			//time of day
				GUI.TextArea( new Rect(1*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT, BOX_WIDTH, 20),"Time ("+SUNMASTER.Current_Time.ToString("F2")+")");
			...
			//WAVE HEIGHT
				GUI.TextArea( new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50, BOX_WIDTH, 20),"Wave height");
				WaterHandler.waterScaleOffset.y = GUI.HorizontalSlider(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50, BOX_WIDTH, 20),WaterHandler.waterScaleOffset.y,0f,3);

			//BOAT SPEED
				GUI.TextArea( new Rect(4*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+0, BOX_WIDTH, 20),"Boat Speed");
				WaterHeightHandle.BoatSpeed = GUI.HorizontalSlider(new Rect(4*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+0, BOX_WIDTH, 20),WaterHeightHandle.BoatSpeed,0.3f,5);
					

				//EXTRA CONTROLS
				if(1==1){
					if (GUI.Button(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50, BOX_WIDTH, 20), "Reset water")){
					...
					if (GUI.Button(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50+25, BOX_WIDTH, 20), "Water controls")){
						if(offsetsON){
							offsetsON = false;
						}else{
							offsetsON = true;
					...
					if(offsetsON){
						GUI.TextArea( new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50+1*50, BOX_WIDTH*1, 20),"Fresnel Power");
						WaterHandler.FresnelOffset = GUI.HorizontalSlider(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+50+1*50, BOX_WIDTH*3, 20),WaterHandler.FresnelOffset,-0.5f,1.7905f);//
...
//						WaterHandler.FresnelBias = GUI.HorizontalSlider(new Rect(9*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+50+2*50, BOX_WIDTH*3, 20),WaterHandler.FresnelBias,-130f,240);
						GUI.TextArea( new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50+2*50, BOX_WIDTH*1, 20),"Foam");
						WaterHandler.FoamOffset = GUI.HorizontalSlider(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+50+2*50, BOX_WIDTH*3, 20),WaterHandler.FoamOffset,0,24);

						GUI.TextArea( new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50+3*50, BOX_WIDTH*1, 20),"Specular focus");
						WaterHandler.BumpFocusOffset = GUI.HorizontalSlider(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+50+3*50, BOX_WIDTH*3, 20),WaterHandler.BumpFocusOffset,-4,4);//

						GUI.TextArea( new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50+4*50, BOX_WIDTH*1, 20),"Depth Offset");
						WaterHandler.ShoreBlendOffset = GUI.HorizontalSlider(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+50+4*50, BOX_WIDTH*3, 20),WaterHandler.ShoreBlendOffset,-0.155f,0.1f);//-0.031f

						GUI.TextArea( new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+50+5*50, BOX_WIDTH*1, 20),"Depth FX");
						WaterHandler.DepthColorOffset = GUI.HorizontalSlider(new Rect(5*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+25+50+50+5*50, BOX_WIDTH*3, 20),WaterHandler.DepthColorOffset,-140f,10);
					}
				}
...
//		}
		...
		if((SUNMASTER.currentWeather!=null && SUNMASTER.currentWeather.currentState != WeatherSM.Volume_Weather_State.FadeIn) | SUNMASTER.currentWeather == null){
			...
			if (GUI.Button(new Rect(4*(BOX_WIDTH+XOffset), 0, BOX_WIDTH, 22), "Rain")){
...
//
				//ATOLL COLORS
//				if (GUI.Button(new Rect(0*(BOX_WIDTH+XOffset), 1*BOX_HEIGHT+50+20+25+50, BOX_WIDTH, 20), "Atoll colors")){
//					if(colorsON){
//						colorsON = false;
//					}else{
//						colorsON = true;
...
//				}
//				if(colorsON){
//					GUI.TextArea( new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+50, BOX_WIDTH+32, 20),"Base Color (RGBA)");
//					WaterHandler.AtollWaterColor.r = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+25+50, BOX_WIDTH, 20),WaterHandler.AtollWaterColor.r,0f,4f);
//					WaterHandler.AtollWaterColor.g = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+25+25+50, BOX_WIDTH, 20),WaterHandler.AtollWaterColor.g,0f,1f);
//					WaterHandler.AtollWaterColor.b = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+25+25+25+50, BOX_WIDTH, 20),WaterHandler.AtollWaterColor.b,0f,1f);
//					WaterHandler.AtollWaterColor.a = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 5*BOX_HEIGHT+25+25+25+25+50, BOX_WIDTH, 20),WaterHandler.AtollWaterColor.a,0f,1f);
//
//					GUI.TextArea( new Rect(1*(BOX_WIDTH+XOffset), 9*BOX_HEIGHT, BOX_WIDTH+50, 20),"Reflect Color (RGBA)");
//					WaterHandler.AtollReflectColor.r = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 9*BOX_HEIGHT+25+50, BOX_WIDTH, 20),WaterHandler.AtollReflectColor.r,0f,4f);
//					WaterHandler.AtollReflectColor.g = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 9*BOX_HEIGHT+25+25+50, BOX_WIDTH, 20),WaterHandler.AtollReflectColor.g,0f,1f);
//					WaterHandler.AtollReflectColor.b = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 9*BOX_HEIGHT+25+25+25+50, BOX_WIDTH, 20),WaterHandler.AtollReflectColor.b,0f,1f);
//					WaterHandler.AtollReflectColor.a = GUI.HorizontalSlider(new Rect(1*(BOX_WIDTH+XOffset), 9*BOX_HEIGHT+25+25+25+25+50, BOX_WIDTH, 20),WaterHandler.AtollReflectColor.a,0f,1f);
//				}
