	...
	void OnRenderImage(RenderTexture source, RenderTexture destination) {
		...
		var shouldRender =
			...
			&& (	(cam && cam.actualRenderingPath == RenderingPath.DeferredShading) 
					|| (AtmosphericScatteringSkyMaster.instance && AtmosphericScatteringSkyMaster.instance.forcePostEffect)
			);
		...
		static void CustomGraphicsBlit(RenderTexture src, RenderTexture dst, Material mat, int pass, Texture2D FractalTex,float TextureAmount) { //v3.6
