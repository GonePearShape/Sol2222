        ...
        Pass {    
           ...
           //Blend One One
            ...
            fixed4 frag (v2f i) : SV_Target
            {
               ...
               float3 finalCol = (_Glow)* i.color.rgb + col * float3(_SunColor.r,_SunColor.g,_SunColor.b) * lerp_vec * 2 * _SunLightIntensity *_LightIntensity* _LightColor0.rgb  + _MinLight; //v3.3
